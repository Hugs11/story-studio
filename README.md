...
- Publish the first clean GitHub release as `v0.8.9`.
- Add curated screenshots to this README.
- Smoke-test the Windows installer generated by the release workflow.
